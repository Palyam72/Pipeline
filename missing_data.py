...
def mean_median_imputer():
    ...
    imputation_method=st.selectbox("How you want to fill the missing values in numerical columns",['median','mean'])
    variables=st.multiselect("List of numerical columns to impute",[st.session_state['dataset'].select_dtypes(include=['int8','int32','int64','float32','float64']).columns])
